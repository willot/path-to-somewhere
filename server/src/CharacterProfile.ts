...
export const monkProfile: CharacterProfile = {
    name: "monk",
...
export const wizardProfile: CharacterProfile = {
    name: "wizard",
...
export const warriorProfile: CharacterProfile = {
    name: "warrior",
...
export const knightProfile: CharacterProfile = {
    name: "knight",
